...
//////////////////////////////////  
  ...
  array (
    'name' => 'products',
    'type' => 'link',
    'relationship' => 'accounts_products',
    'module'=>'Products',
    'bean_name'=>'Products',
    'source'=>'non-db',
        'vname'=>'LBL_PRODUCTS',
...
, 'relationships' => array (
    ...
    ,'account_quotes' => array('lhs_module'=> 'Accounts', 'lhs_table'=> 'accounts', 'lhs_key' => 'id',
    ...
    ,'accounts_products' => array('lhs_module'=> 'Accounts', 'lhs_table'=> 'accounts', 'lhs_key' => 'id',
                              'rhs_module'=> 'Products', 'rhs_table'=> 'products', 'rhs_key' => 'account_id', 
                              'relationship_type'=>'one-to-many') 
