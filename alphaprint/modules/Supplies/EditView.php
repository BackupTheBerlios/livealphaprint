...
/// SETUP SUPPLIER POPUP

$popup_supplier_request_data = array(
	'call_back_function' => 'set_return',
	'form_name' => 'EditView',
	'field_to_name_array' => array(
		'id' => 'supplier_id',
...
$encoded_supplier_popup_request_data = $json->encode($popup_supplier_request_data);
$xtpl->assign('encoded_supplier_popup_request_data', $encoded_supplier_popup_request_data);

//////////////////////////////////////
///
// SETUP PURCHASE ORDER POPUP 

$popup_purchaseorder_request_data = array(
	'call_back_function' => 'set_return',
	'form_name' => 'EditView',
	'field_to_name_array' => array(
		'id' => 'purchaseorder_id',
		'num' => 'purchaseorder_num',
		),
	);
$encoded_purchaseorder_popup_request_data = $json->encode($popup_purchaseorder_request_data);
$xtpl->assign('encoded_purchaseorder_popup_request_data', $encoded_purchaseorder_popup_request_data);

//////////////////////////////////////
///
/*/ (ivan)TODO: SETUP SALES ORDER POPUP (when it's ready)
...
if (isset($_REQUEST['return_module'])){
	...
	$xtpl->assign("RETURN_MODULE", 'Supplies');
}
...
if ((!$focus->num_pref) && (!$focus->supplynum)){
    $ppref = 'SPL';
...
{
	$xtpl->assign("PRODUCTROWS",$focus->getProductRow(new SupplyLine(),0,true));
...
$xtpl->assign("CATEGORY_OPTIONS", get_select_options_with_id($app_list_strings['supply_category_dom'], $focus->category));
$xtpl->assign("STATUS_OPTIONS", get_select_options_with_id($app_list_strings['supply_status_dom'], $focus->category));
