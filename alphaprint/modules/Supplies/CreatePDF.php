...
$num_pages=ceil(($num_materials/$materials_per_page));
$current_material=0;
...
for($l=0;$l<$num_pages;$l++)
{
	...
	while($current_material != $num_materials) // PP 17.12.2006 Fixed Logic Error 
	{
		$line[]=$material_line[$current_material];
		$current_material++;
	}
...
$pdf->Output('Supply.pdf','D'); //added file name to make it work in IE, also forces the download giving the user the option to save
