...
class QuoteLine extends SugarBean
{
   ...
   var $created_by;
   var $table_name = 'quotelines';
   var $object_name = 'QuoteLine';
   var $module_dir = 'QuoteLines';
   var $new_schema = true;
	//product definitions
   var $pages;
   var $quantity; 
   ...
   function get_xtemplate_data() {
	...
	function fill_in_additional_list_fields() {
		...
		$this->singleTotal = (($this->quantity * $this->trade_price) - (($this->quantity * $this->trade_price) * ($this->discount/100)) - $this->discount_amt);
	}
}
