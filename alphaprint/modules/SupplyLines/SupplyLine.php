...
class SupplyLine extends SugarBean
{
	// Stored fields
   var $id;   
   ...
   var $created_by;
   var $table_name = 'supplylines';
   var $object_name = 'SupplyLine';
   ...
   function get_xtemplate_data() {
	...
	function mark_deletedBySupplyid($supplyid) {
		$return_array = $this->get_full_list("id","supplyid='".$supplyid."'");
