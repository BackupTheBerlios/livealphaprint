...
$mod_strings = array ( 
   'LBL_MODULE_NAME' => 'Материали' ,
   'LBL_MODULE_TITLE' => 'Материали: Начало' ,
   'LBL_SEARCH_FORM_TITLE' => 'Търси материали' ,
   'LBL_LIST_FORM_TITLE' => 'Списък с материали' ,
   'LBL_HISTORY_TITLE' => 'История' ,
   'LBL_MATERIAL_GENERAL' => 'Обща информация' ,
   ...
   'LBL_TYPE' => 'Тип:' ,
   'LBL_MAN' => 'Производител:' ,
   'LBL_CHAR' => 'Характеристики:' ,
   'LBL_MEASURE' => 'Мярка:' ,
   'LBL_NUM' => 'Номер:' ,
