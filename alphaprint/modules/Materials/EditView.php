...
require_once('modules/Materials/Forms.php');
...
$GLOBALS['log']->info("Materials detail view");

$xtpl=new XTemplate ('modules/Materials/EditView.html');
...
$xtpl->assign('TYPE_OPTIONS', get_select_options_with_id($app_list_strings['material_type_options'], $focus->type));
$xtpl->assign('CATEGORY_OPTIONS',get_select_options_with_id($app_list_strings['material_category_options'], $focus->category));
