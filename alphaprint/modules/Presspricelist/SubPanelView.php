...
$button .= "<input type='hidden' name='module' value='Presspricelist'>\n";
...
$ListView->initNewXTemplate( 'modules/Presspricelist/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRESSPRICELIST_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRESSPRICELIST_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "PRESSPRICELIST");
