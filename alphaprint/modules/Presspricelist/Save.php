...
$query = ' SELECT '.$sugarbean->table_name.'.default FROM '.$sugarbean->table_name.' WHERE '.$sugarbean->table_name.'.default="on" AND inks_number="'.$_REQUEST['inks_number'].'" AND pressmachine_id="'.$_REQUEST['pressmachine_id'].'"';
