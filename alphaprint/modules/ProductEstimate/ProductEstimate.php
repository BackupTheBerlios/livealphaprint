...
/**
 * Data access layer for the productestimate table
 *
 ...
 *
 */
class ProductEstimate extends SugarBean {
	...
	var $object_name = 'ProductEstimate';
	var $module_dir = 'ProductEstimate';
	var $new_schema = true;
	var $table_name = 'productestimate';
	...
	function create_list_query($order_by, $where, $show_deleted = 0)
	{
		...
		$query = "SELECT users.user_name assigned_user_name, productestimate.*";
		...
		$query .= " FROM productestimate ";




          $query .= "LEFT JOIN users ON productestimate.assigned_user_id=users.id ";
          //$query .= "LEFT JOIN productestimate_relation ON productestimate.id=productestimate_relation.productestimate_id ";
...
//die($query);
	...
	function build_generic_where_clause ($the_query_string)
	{
		...
		array_push($where_clauses, "productestimate.name LIKE '%$the_query_string%'");
	...
	function create_export_query(&$order_by, &$where)
    {
        ...
        $query .= " LEFT JOIN users
                   	ON productestimate.assigned_user_id=users.id ";




        $where_auto = " productestimate.deleted=0 ";
    ...
    function componentsEstimate($product_id){
    	
    	$component_html = "";
    	$component_estimate = new ComponentEstimate();
    	$component_list = $component_estimate->get_full_list("id","product_id='".$product_id."'");
    	$total_paper = 0;
    	$total_prepress = 0;
    	$total_press = 0;
    	$total_operations = 0; 
