...
$button .= "<input type='hidden' name='module' value='ProductEstimate'>\n";
...
$ListView->initNewXTemplate( 'modules/ProductEstimate/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRODUCTESTIMATE_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRODUCTESTIMATE_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "PRODUCTESTIMATE");
