...
$button .= "<input type='hidden' name='module' value='Operations'>\n";
...
$ListView->initNewXTemplate( 'modules/Operations/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_OPERATION_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_OPERATION_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "OPERATION");
