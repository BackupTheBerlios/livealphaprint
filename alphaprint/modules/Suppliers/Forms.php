...
$lbl_supplier_name = $mod_strings['LBL_LIST_SUPPLIER_NAME'];
...
require_once('modules/Suppliers/SupplierFormBase.php');
$supplierForm = new SupplierFormBase();
return $supplierForm->getForm('','Suppliers');
}
