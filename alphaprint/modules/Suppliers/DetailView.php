...
$xtpl=new XTemplate ('modules/Suppliers/DetailView.html');
...
$xtpl->assign("PAY_TERMS", $focus->pay_terms);
...
if(ACLController::checkAccess('Contacts', 'edit', true)) {
	$push_billing = '<input class="button" title="' . $mod_strings['LBL_PUSH_CONTACTS_BUTTON_LABEL'] . 
						 '" type="button" onclick=\'open_popup("Contacts", 600, 600, "&supplier_name=' .
