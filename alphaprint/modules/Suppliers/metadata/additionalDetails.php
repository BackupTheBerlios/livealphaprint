...
function additionalDetailsAccount($fields) {
	...
	return array('fieldToAddTo' => 'NAME', 
				 ...
				 'editLink' => "index.php?action=EditView&module=Suppliers&return_module=Suppliers&record={$fields['ID']}", 
				 'viewLink' => "index.php?action=DetailView&module=Suppliers&return_module=Suppliers&record={$fields['ID']}");
}
