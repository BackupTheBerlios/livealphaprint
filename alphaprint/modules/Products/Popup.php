...
//{PRODUCT.ID}", "{PRODUCT.NAME}", "{PRODUCT.PNUM}", "{PRODUCT.UNITPRICE}")
/*
sHTML = sHTML.replace('cost_price','cost_price_' + count);
	 ...
	 sHTML = sHTML.replace('product_name','product_name_' + count);
	 sHTML = sHTML.replace('product_id','product_id_' + count);
	 sHTML = sHTML.replace('product_num','product_num_' + count);
*/
if($_REQUEST['form'] == 'EditView')
{
	...
	$the_javascript .= "	window.opener.document.EditView.productid_$index.value = id;\n";
	$the_javascript .= "	window.opener.document.EditView.productname_$index.value = name;\n";
	$the_javascript .= "	window.opener.document.EditView.productnum_$index.value = pnum;\n";
	...
	$the_javascript .= "	window.opener.document.EditView.product_id_$index.value = ''; \n";
	$the_javascript .= "	window.opener.document.EditView.product_name_$index.value = ''; \n";
	$the_javascript .= "	window.opener.document.EditView.product_num_$index.value = ''; \n";
...
$ListView->setQuery($where, "", "pnum, name", "PRODUCT");
$ListView->setModStrings($mod_strings);
$ListView->process_for_popups = true;
$ListView->processListView($seed_object, "main", "PRODUCT");
