...
$ListView->setHeaderTitle($current_module_strings['LBL_PRODUCTS_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRODUCTS_SUBPANEL_TITLE'] . $header_text);
