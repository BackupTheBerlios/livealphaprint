...
$xtpl->assign('encoded_components_popup_request_data', $json->encode($popup_request_data));
...
/*if (isset($_REQUEST['parent_name'])){
	$focus->product_name = $_REQUEST['parent_name'];
...
if (isset($_REQUEST['parent_id'])){
	$focus->parent_id = $_REQUEST['parent_id'];
	 ...
	 /* if(!isset($focus->id)){
	    ...
	    $quanity_var = $result_array['parent_id'];
	    $query2 = "SELECT quantity from products where deleted=0 AND id='$quanity_var'";
	    ...
	    $focus->whole_sheets_quantity  = $quantity;
...
$xtpl->assign("IMAGE_PATH", $image_path);$xtpl->assign("PRINTING_URL", "index.php?".$GLOBALS['request_string']);
...
$xtpl->assign("count_whole_sheets", $focus->count_whole_sheets);
...
/*
$xtpl->assign("printing_price", $focus->printing_price);
$xtpl->assign("paper_price", $focus->paper_price);
$xtpl->assign("material_price", $focus->material_price);
$xtpl->assign("other_price", $focus->other_price);
$xtpl->assign("total_price", $focus->total_price);*/
