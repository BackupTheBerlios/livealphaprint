...
$button .= "<input type='hidden' name='module' value='Machines'>\n";
...
if ($currentModule == 'Accounts')
{
	...
	$button .= "<input title='".$app_strings['LBL_SELECT_BUTTON_TITLE']
		...
		."  ' name='button' onclick='open_popup(\"Machines\", 600, 400, \"\", false, true, {$encoded_popup_request_data});'>\n";
}
elseif ($currentModule == 'Contacts')
{
	///////////////////////////////////////
	...
	$button .= "<input title='".$app_strings['LBL_SELECT_BUTTON_TITLE']
		...
		."  ' name='button' onclick='open_popup(\"Machines\", 600, 400, \"&account_id={$focus->account_id}&account_name=".urlencode($focus->account_name)."\", false, true, {$encoded_popup_request_data});'>\n";
//		."  ' name='button' onclick='window.open(\"index.php?module=Machines&action=Popup&html=Popup_picker&form=ContactDetailView&form_submit=true&query=true&account_id=$focus->account_id&account_name=".urlencode($focus->account_name)."\",\"new\",\"width=600,height=400,resizable=1,scrollbars=1\");'>\n";
}
