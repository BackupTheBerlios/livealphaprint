...
$products_module_strings = return_module_language($current_language, 'Products');
...
$button .= "<input type='hidden' name='module' value='ProductComponents' />\n";
...
$ListView->initNewXTemplate( 'modules/ProductComponents/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($products_module_strings['LBL_PROJECT_TASK_SUBPANEL_TITLE'] . $header_text);

$ListView->setHeaderText($button);
$ListView->setQuery('', '', 'type', 'products_components');
$ListView->processListView($focus_list, 'main', 'products_components');
