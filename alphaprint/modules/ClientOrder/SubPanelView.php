...
$button .= "<input type='hidden' name='module' value='ClientOrder'>\n";
...
$ListView->initNewXTemplate( 'modules/ClientOrder/SubPanelView.html',$current_module_strings);
