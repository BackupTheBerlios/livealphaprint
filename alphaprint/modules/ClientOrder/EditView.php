...
require_once('modules/ClientOrder/Forms.php');
...
$xtpl=new XTemplate ('modules/ClientOrder/EditView.html');
...
$xtpl->assign("clientorder_files_options", get_select_options_with_id($app_list_strings['clientorder_files_options'], $focus->files));
$xtpl->assign("clientorder_period_options", get_select_options_with_id($app_list_strings['clientorder_period_options'], $focus->periodic));
$xtpl->assign("clientorder_samples_options", get_select_options_with_id($app_list_strings['clientorder_samples_options'], $focus->samples));
