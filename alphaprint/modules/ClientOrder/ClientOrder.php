...
/**
 * Data access layer for the clientorder table
 *
 ...
 *
 */
class ClientOrder extends SugarBean {
	...
	var $object_name = 'ClientOrder';
	var $module_dir = 'ClientOrder';
	var $new_schema = true;
	var $table_name = 'clientorder';
	...
	function create_list_query($order_by, $where, $show_deleted = 0)
	{
		...
		$query = "SELECT users.user_name assigned_user_name, clientorder.*";
		...
		$query .= " FROM clientorder ";




          $query .= "LEFT JOIN users ON clientorder.assigned_user_id=users.id ";
          //$query .= "LEFT JOIN clientorder_relation ON clientorder.id=clientorder_relation.clientorder_id ";
...
//die($query);
	...
	function build_generic_where_clause ($the_query_string)
	{
		...
		array_push($where_clauses, "clientorder.name LIKE '%$the_query_string%'");
	...
	function create_export_query(&$order_by, &$where)
    {
        ...
        $query .= " LEFT JOIN users
                   	ON clientorder.assigned_user_id=users.id ";




        $where_auto = " clientorder.deleted=0 ";
