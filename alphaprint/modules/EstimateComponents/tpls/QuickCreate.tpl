...
<form name="estimateComponentsQuickCreate" id="estimateComponentsQuickCreate" method="POST" action="index.php"    onMouseMove="number_components(estimateComponentsQuickCreate);name_components(estimateComponentsQuickCreate);" > 
  <input type="hidden" name="module" value="EstimateComponents"> 
  <input type="hidden" name="estimates_id" value="{$REQUEST.estimates_id}"> 
  ...
  <input type="hidden" id="formname" name="formname" value="estimateComponentsQuickCreate" />  
  <table width="100%" cellpadding="0" cellspacing="0" border="0" > 
    <tr> 
      <td align="left" style="padding-bottom: 2px;"> <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="button" type="submit" name="button" {$saveOnclick|default:"onclick=\"return check_form('EstimateComponentsQuickCreate');\""} value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " > 
...
&nbsp; 
	...
	onclick='open_popup("Estimates", 600, 400, "", true, false, {$encoded_parent_popup_request_data});'
	/> 
            </slot></td> 
          {/if} </tr> </table> 
      <br><br>  
          ...
          <TR> 
            <TD> <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0> 
                <TBODY> 
                  ...
                  <TR> 
                    <TD colSpan=4> <table cellSpacing=0 cellPadding=0 width="100%" border=0 id="estimatetable" name="estimatetable"> 
                        <tr> 
                          <td> <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 id="estimatetable1" name="estimatetable1"> 
                              <TR> 
                      ...
                      <DIV id="rows"> 
                        <table cellSpacing=0 cellPadding=0 width="100%" border=0 id="estimatetableid2" name="estimatetablename2"> 
                         
                          {$LAYOUTROWS}
                         
                        </table> 
                      </DIV> 
                      <DIV id="estimate_row_id" name="estimate_row_name" style='DISPLAY: none'> 
                        <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 id="estimate_row_table" name="estimate_row_table"> 
                          <TR> 
