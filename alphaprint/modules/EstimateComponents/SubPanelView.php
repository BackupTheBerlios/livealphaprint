...
$estimates_module_strings = return_module_language($current_language, 'Estimates');
...
$ListView->initNewXTemplate( 'modules/EstimateComponents/SubPanelView.html',$current_module_strings);
