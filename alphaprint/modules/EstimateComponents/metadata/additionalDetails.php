...
function additionalDetailsEstimateComponents($fields) {
	static $mod_strings;
	...
	return array('fieldToAddTo' => 'NAME', 
				 ...
				 'editLink' => "index.php?action=EditView&module=EstimateComponents&return_module=EstimateComponents&record={$fields['ID']}", 
				 'viewLink' => "index.php?action=DetailView&module=EstimateComponents&return_module=EstimateComponents&record={$fields['ID']}");
}
