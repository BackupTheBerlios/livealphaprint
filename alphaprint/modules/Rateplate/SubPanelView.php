...
$button .= "<input type='hidden' name='module' value='Rateplate'>\n";
...
$ListView->initNewXTemplate( 'modules/Rateplate/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_RATEPLATE_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_RATEPLATE_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "RATEPLATE");
