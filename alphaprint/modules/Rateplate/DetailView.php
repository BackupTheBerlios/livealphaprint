...
/**
 * The detailed view for a rateplate
 *
...
$GLOBALS['log']->info('Rateplate detail view');
$focus = new Rateplate();
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("RATEPLATE", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/Rateplate/DetailView.html');
...
$detailView->processListNavigation($xtpl, "RATEPLATE", $offset);
...
$subpanel = new SubPanelTiles($focus, 'Rateplate');
