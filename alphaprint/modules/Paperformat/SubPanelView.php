...
$button .= "<input type='hidden' name='module' value='Paperformat'>\n";
...
$ListView->initNewXTemplate( 'modules/Paperformat/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_PAPERFORMAT_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PAPERFORMAT_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "PAPERFORMAT");
