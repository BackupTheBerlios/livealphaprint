...
class Pricelistline extends SugarBean
{
	// Stored fields
   var $id;   
   ...
   var $table_name = 'pricelistlines';
   var $object_name = 'Pricelistline';
   var $module_dir = 'Pricelistlines';
   var $new_schema = true;
	//product definitions
   var $pages;
   var $quantity; 
   ...
   function get_xtemplate_data() {
	...
	function mark_deletedBypricelistid($pricelist_id) {
		$return_array = $this->get_full_list("id","pricelist_id='".$pricelist_id."'");
