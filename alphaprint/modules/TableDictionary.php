...
include_once("metadata/products_relationMetaData.php");
include_once("metadata/suppliers_contactsMetaData.php");
include_once("metadata/materials_relationMetaData.php");
include_once("metadata/papers_relationMetaData.php");
