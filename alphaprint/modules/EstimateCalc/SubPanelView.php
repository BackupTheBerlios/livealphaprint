...
$button .= "<input type='hidden' name='module' value='EstimateCalc'>\n";
...
$ListView->initNewXTemplate( 'modules/EstimateCalc/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_ESTIMATECALC_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_ESTIMATECALC_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "ESTIMATECALC");
