...
'LBL_MODULE_TITLE' => 'Срещи: Начало' ,
'LBL_SEARCH_FORM_TITLE' => 'Търсене на срещи' ,
'LBL_LIST_FORM_TITLE' => 'Списък на срещи' ,
'LBL_NEW_FORM_TITLE' => 'Насрочи среща',
...
'LBL_DATE_TIME' => 'Начална дата и време:' ,
...
'NTC_REMOVE_INVITEE' => 'Желаете ли да изтриете поканения от срещата?',
'LBL_INVITEE' => 'Покана' ,
'LNK_NEW_APPOINTMENT' => 'Създай среща' ,

'LBL_ADD_INVITEE' => 'Добави покана' ,
'LBL_NAME' => 'Име' ,
'LBL_FIRST_NAME' => 'Име' ,
...
'LBL_SEND_BUTTON_TITLE' => 'Изпрати покана [Alt+I]' ,
'LBL_SEND_BUTTON_KEY' => 'I' ,
'LBL_SEND_BUTTON_LABEL' => 'Изпрати покана' ,
'LBL_REMINDER_TIME' => 'Време на напомняне' ,
'LBL_MODIFIED_BY' => 'Променео от' ,
...
'LBL_LIST_DUE_DATE' => 'Завършена на дата' ,
'LBL_LIST_DATE_MODIFIED' => 'Променена на дата' ,
