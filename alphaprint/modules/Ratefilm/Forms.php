...
{
	if(!ACLController::checkAccess('Ratefilm', 'edit', true))return '';
	global $app_strings;
	global $mod_strings;
	global $currentModule;
	global $current_user;

	$the_form = get_left_form_header($mod_strings['LBL_QUICK_NEW_RATEFILM']);
	$form = new XTemplate ('modules/Ratefilm/Forms.html');
