...
$button .= "<input type='hidden' name='module' value='Ratefilm'>\n";
...
$ListView->initNewXTemplate( 'modules/Ratefilm/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_RATEFILM_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_RATEFILM_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "RATEFILM");
