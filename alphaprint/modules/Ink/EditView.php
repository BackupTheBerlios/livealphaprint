...
require_once('modules/Ink/Forms.php');
...
$xtpl=new XTemplate ('modules/Ink/EditView.html');
...
$xtpl->assign("TYPE_OPTIONS", get_select_options_with_id($app_list_strings['ink_type_options'], $focus->type));
$xtpl->assign("CMYK_TYPE_OPTIONS", get_select_options_with_id($app_list_strings['cmyk_ink_type_options'], $focus->cmyk_type));
$xtpl->assign("PANTONE_OPTIONS", get_select_options_with_id($app_list_strings['pantone_ink_type_options'], $focus->pantone));
