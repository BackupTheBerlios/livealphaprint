...
$button .= "<input type='hidden' name='module' value='Ink'>\n";
...
$ListView->initNewXTemplate( 'modules/Ink/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_INK_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_INK_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "INK");
