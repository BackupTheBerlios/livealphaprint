...
/**
 * Data access layer for the ink table
 *
...
class Ink extends SugarBean {
	...
	function create_list_query($order_by, $where, $show_deleted = 0)
	{
		...
		$query = "SELECT users.user_name assigned_user_name, ink.*";
		...
		$query .= " FROM ink ";
          ...
          $query .= "LEFT JOIN users ON ink.assigned_user_id=users.id ";
          //$query .= "LEFT JOIN ink_relation ON ink.id=ink_relation.ink_id ";
...
//die($query);
	...
	function create_export_query(&$order_by, &$where)
    {
        ...
        $query .= " LEFT JOIN users
                   	ON ink.assigned_user_id=users.id ";




        $where_auto = " ink.deleted=0 ";
