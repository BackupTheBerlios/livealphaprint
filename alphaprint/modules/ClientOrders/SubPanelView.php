...
$button .= "<input type='hidden' name='module' value='ClientOrders'>\n";
...
$ListView->initNewXTemplate( 'modules/ClientOrders/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_CLIENTORDERS_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_CLIENTORDERS_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "CLIENTORDERS");
