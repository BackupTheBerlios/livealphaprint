...
class Popup_Picker
{
	...
	function process_page()
	{
		...
		$form = new XTemplate('modules/ClientOrders/Popup_picker.html');
		...
		$ListView->setQuery($where, '', 'name', 'CLIENTORDERS');
		$ListView->setModStrings($mod_strings);

		ob_start();
		$ListView->processListView($seed_bean, 'main', 'CLIENTORDERS');
		$output_html .= ob_get_contents();
		ob_end_clean();
