...
function generate_email() {
	...
	function getClientorderComponentsRow($productrow,$index) {
    	...
    	$tablerow .= '<TD width="5%" class=listViewThS1 ><a href="index.php?module=ClientorderComponents&action=EditView&record='.$productrow->id.'&return_module=ClientOrders&return_action=EditView&return_id='.$this->id.'"><img src="themes/AlphaLight/images/edit_inline.gif" width="12" height="12" align="absmiddle" alt="Промени" border="0"></a></TD>';
		$tablerow .= '<TD width="5%" class=listViewThS1 ><a href="index.php?module=ClientorderComponents&action=Delete&record='.$productrow->id.'&return_module=ClientOrders&return_action=EditView&return_id='.$this->id.'"><img src="themes/AlphaLight/images/delete_inline.gif" width="12" height="12" align="absmiddle" alt="Премахни" border="0"></a></TD>';
	 	$tablerow .= '</TR>';
