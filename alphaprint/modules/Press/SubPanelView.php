...
$button .= "<input type='hidden' name='module' value='Press'>\n";
...
$ListView->initNewXTemplate( 'modules/Press/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRESS_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRESS_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "PRESS");
