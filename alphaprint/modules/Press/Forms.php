...
{
	if(!ACLController::checkAccess('Press', 'edit', true))return '';
	global $app_strings;
	global $mod_strings;
...
function get_pressline_js () {
	...
	{ 
         ...
         sHTML = sHTML.replace('layoutid','layout_id_' + count);
		 sHTML = sHTML.replace('layoutname','layout_name_' + count );
		 sHTML = sHTML.replace('part','part_' + count );
         sHTML = sHTML.replace('layoutname_popup','layout_name_' + count);
         sHTML = sHTML.replace('layoutid_popup','layout_id_' + count ); 
