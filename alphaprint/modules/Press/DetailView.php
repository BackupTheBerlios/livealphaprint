...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("PRESS", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/Press/DetailView.html');
...
for ($i=0;$i<count($pressrows);$i++) {
        ...
        $xtpl->assign("PRESSROWS",$focus->getPresslineRow($pressrows[$i],$i,false));
...
$detailView->processListNavigation($xtpl, "PRESS", $offset);
...
$subpanel = new SubPanelTiles($focus, 'Press');
