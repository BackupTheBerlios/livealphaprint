...
/**
 * The detailed view for a pressformat
 *
...
$GLOBALS['log']->info('Pressformat detail view');
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("PRESSFORMAT", $focus, $offset);
	if($result == null) {
...
$xtpl = new XTemplate('modules/Pressformat/DetailView.html');
...
$detailView->processListNavigation($xtpl, "PRESSFORMAT", $offset);
...
$subpanel = new SubPanelTiles($focus, 'Pressformat');
