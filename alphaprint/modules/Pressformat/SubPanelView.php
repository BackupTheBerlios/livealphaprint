...
$button .= "<input type='hidden' name='module' value='Pressformat'>\n";
...
$ListView->initNewXTemplate( 'modules/Pressformat/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRESSFORMAT_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRESSFORMAT_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "PRESSFORMAT");
