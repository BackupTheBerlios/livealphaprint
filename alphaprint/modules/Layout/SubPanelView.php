...
$button .= "<input type='hidden' name='module' value='Layout'>\n";
...
$ListView->initNewXTemplate( 'modules/Layout/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_LAYOUT_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_LAYOUT_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "LAYOUT");
