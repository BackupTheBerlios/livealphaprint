...
'LBL_LAYOUT_SUBPANEL_TITLE' => 'Предпечат' ,
'LBL_LAYOUT_TASK_SUBPANEL_TITLE' => 'Проектни задачи' ,
...
'CONTACT_REMOVE_LAYOUT_CONFIRM' => 'Желаете ли да изтриете този контакт от предпечата?',

'LNK_NEW_LAYOUT' => 'Нов предпечат' ,
'LNK_LAYOUT_LIST' => 'Предпечат' ,
'LNK_NEW_LAYOUT_TASK' => 'Нова предпечатна задача' ,
'LNK_LAYOUT_TASK_LIST' => 'Проектни задачи' ,
'LBL_DEFAULT_SUBPANEL_TITLE' => 'Предпечат' ,
'LBL_ACTIVITIES_TITLE' => 'Дейности' ,
'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Дейности' ,
'LBL_HISTORY_SUBPANEL_TITLE' => 'История' ,
'LBL_QUICK_NEW_LAYOUT' => 'Нов предпечат' ,

'LBL_LAYOUT_TASKS_SUBPANEL_TITLE' => 'Проектни задачи' ,
