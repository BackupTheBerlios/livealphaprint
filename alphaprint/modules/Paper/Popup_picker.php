...
class Popup_Picker
{
	...
	function process_page()
	{
		...
		$name = empty($_REQUEST['pname']) ? '' : $_REQUEST['pname'];
		...
		$form = new XTemplate('modules/Paper/Popup_picker.html');
		$form->assign('MOD', $mod_strings);
		$form->assign('APP', $app_strings);
		$form->assign('THEME', $theme);
		$form->assign('MODULE_NAME', $currentModule);
		$form->assign('PNAME', $name);
		...
		$ListView->setQuery($where, '', 'pname', 'PAPER');
		$ListView->setModStrings($mod_strings);

		ob_start();
		$ListView->processListView($seed_bean, 'main', 'PAPER');
		$output_html .= ob_get_contents();
		ob_end_clean();
