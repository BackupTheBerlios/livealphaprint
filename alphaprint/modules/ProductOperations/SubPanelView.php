...
$ListView->initNewXTemplate( 'modules/ProductOperations/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRODUCTOPERATION_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRODUCTOPERATION_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "PRODUCTOPERATION");
