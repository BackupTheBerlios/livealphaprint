...
/**
 * ComponentEstimateCalc sub-panel
 *
...
$button .= "<input type='hidden' name='module' value='ComponentEstimateCalc'>\n";
...
$ListView->initNewXTemplate( 'modules/ComponentEstimateCalc/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_COMPONENTESTIMATECALC_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_COMPONENTESTIMATECALC_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "COMPONENTESTIMATECALC");
