...
{
	if(!ACLController::checkAccess('ComponentEstimateCalc', 'edit', true))return '';
	global $app_strings;
	global $mod_strings;
	global $currentModule;
	global $current_user;

	$the_form = get_left_form_header($mod_strings['LBL_QUICK_NEW_COMPONENTESTIMATECALC']);
	$form = new XTemplate ('modules/ComponentEstimateCalc/Forms.html');
