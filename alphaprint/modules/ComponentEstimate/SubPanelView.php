...
$button .= "<input type='hidden' name='module' value='ComponentEstimate'>\n";
...
$ListView->initNewXTemplate( 'modules/ComponentEstimate/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_COMPONENTESTIMATE_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_COMPONENTESTIMATE_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "COMPONENTESTIMATE");
