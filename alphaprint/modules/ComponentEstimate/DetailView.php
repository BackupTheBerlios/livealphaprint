...
/**
 * The detailed view for a componentestimate
 *
...
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
	$result = $detailView->processSugarBean("COMPONENTESTIMATE", $focus, $offset);
	if($result == null) {
...
$detailView->processListNavigation($xtpl, "COMPONENTESTIMATE", $offset);
...
$subpanel = new SubPanelTiles($focus, 'ComponentEstimate');
