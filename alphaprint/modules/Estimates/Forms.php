...
function calc_print_js () {

	$the_script  = <<<EOQ
	<SCRIPT language="Javascript" type="text/javascript" >
	
	<!--
	function calc_print(form) {
		...
		{
			var print = 0.0;
			print = document.getElementById('count_whole_sheets_' + index).value * document.getElementById('print_price_' + index).value;	
			total_print = total_print + print;
		
		}
		document.getElementById('print_price').value = 2*total_print;
