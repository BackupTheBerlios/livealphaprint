...
function get_new_record_form()
{
	...
	$the_form = get_left_form_header($mod_strings['LBL_QUICK_NEW_ESTIMATES']);
	$form = new XTemplate ('modules/Estimates/Forms.html');
...
function get_number_js () {
	...
	function sizeformat(form) {
	 	var sformat = document.EditView.format.options[document.EditView.format.selectedIndex].value;
	
	
		if (sformat == "A4"){
	
			form.fsize_h.value = 21;
			form.fsize_w.value = 30;
		}
		if (sformat == "A3"){
	
			form.fsize_h.value = 30;
			form.fsize_w.value = 42;
		}
		if (sformat == "A2"){
	
			form.fsize_h.value = 42;
			form.fsize_w.value = 60;
		}
		if (sformat == ""){
	
			form.fsize_h.value = sformat;
			form.fsize_w.value = sformat;
		}
