...
$button .= "<input type='hidden' name='module' value='Estimates'>\n";
...
$ListView->initNewXTemplate( 'modules/Estimates/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_ESTIMATES_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_ESTIMATES_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "ESTIMATES");
