...
class Paperwasteline extends SugarBean
{
	// Stored fields
   var $id;   
   ...
   var $table_name = 'paperwasteline';
   var $object_name = 'Paperwasteline';
   var $module_dir = 'Paperwasteline';
   var $new_schema = true;
	//product definitions
   var $pages;
   var $quantity; 
   ...
   function get_xtemplate_data() {
	...
	function mark_deletedBypricelistid($pricelist_id) {
		$return_array = $this->get_full_list("id","paperwaste_id='".$pricelist_id."'");
