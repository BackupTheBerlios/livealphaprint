...
class PurchaseOrder extends SugarBean
{
   ...
   var $required_fields = array('supplier_name','supplier_contact_name', 'order_date', 'delivery_date' );
   ...
   function get_xtemplate_data() {
	...
	function create_export_query(&$order_by, &$where)
	{
			...
			if($custom_join){
				$query .= $custom_join['join'];
					...
					$where_auto = " purchaseorders.deleted=0 ";
	...
	function create_list_query($order_by, $where, $show_deleted=0)
	{
		$custom_join = $this->custom_fields->getJOIN();
			...
			$query .= "			LEFT JOIN users
                                ON purchaseorders.assigned_user_id=users.id ";
			...
			if($show_deleted == 0){
				...
				$where_auto = " purchaseorders.deleted=1 ";
			}
	...
	function getProductRow($productrow,$index,$is_editview=false) {
        ...
        {                                         //Editview
            ...
            $tablerow = $tablerow.'                <img src="themes/default/images/Search.gif" align="absmiddle" style="cursor:hand;cursor:pointer" ' .'LANGUAGE=javascript onclick=\'return window.open("index.php?module=Materials&action=Popup&html=purchaseorders&form=EditView&form_submit=false&index='.$count.'","test","width=600,height=400,resizable=1,scrollbars=1");\'><img src="themes/default/images/Paper.gif" align="absmiddle" style="cursor:hand;cursor:pointer" ' .'LANGUAGE=javascript onclick=\'return window.open("index.php?module=Paper&action=Popup&html=purchaseorders&form=EditView&form_submit=false&index='.$count.'","test","width=600,height=400,resizable=1,scrollbars=1");\'></TD>';
	...
	function fill_in_additional_detail_fields()
	{
		...
		$purchaseorderLines = $this->getProductRows();
	...
	function get_list_view_data(){
		...
		$temp_array['STAGE'] = empty($this->stage)? "" : $app_list_strings['purchaseorder_stage_dom'][$this->stage];
