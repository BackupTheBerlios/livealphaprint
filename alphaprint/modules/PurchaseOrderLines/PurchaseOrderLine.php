...
class PurchaseOrderLine extends SugarBean
{
   ...
   var $created_by;
   var $table_name = 'purchaseorderlines';
   var $object_name = 'PurchaseOrderLine';
   var $module_dir = 'PurchaseOrderLines';
   var $new_schema = true;
   ...
   function get_xtemplate_data() {
	...
	function mark_deletedByPurchaseOrderid($purchaseorderid) {
		$return_array = $this->get_full_list("id","purchaseorderid='".$purchaseorderid."'");
