...
'LBL_TEAM_ID' => 'Екип:' ,
'LBL_NAME' => 'Име:' ,
'LBL_SF' => 'Формат на печат:' ,
'LBL_MF' => 'Макс. формат на печат:' ,
'LBL_MPF' => 'Макс. формат на хартията:' ,
...
'CONTACT_REMOVE_PRESSMACHINE_CONFIRM' => 'Желаете ли да изтриете този контакт от печатна машинаа?',

'LNK_NEW_PRESSMACHINE' => 'Нова печатна машина' ,
'LNK_PRESSMACHINE_LIST' => 'Печатни машини' ,
'LNK_NEW_PRESSMACHINE_TASK' => 'Нова печатна машинана задача' ,
'LNK_PRESSMACHINE_TASK_LIST' => 'Проектни задачи' ,
'LBL_DEFAULT_SUBPANEL_TITLE' => 'Печатни машини' ,
'LBL_ACTIVITIES_TITLE' => 'Дейности' ,
'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Дейности' ,
'LBL_HISTORY_SUBPANEL_TITLE' => 'История' ,
'LBL_QUICK_NEW_PRESSMACHINE' => 'Нова печатна машина' ,
