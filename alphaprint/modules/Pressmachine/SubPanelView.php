...
$button .= "<input type='hidden' name='module' value='Pressmachine'>\n";
...
$ListView->initNewXTemplate( 'modules/Pressmachine/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRESSMACHINE_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRESSMACHINE_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "PRESSMACHINE");
