...
$mod_strings = array ( 
   'LBL_MODULE_NAME' => 'Ценоразпис' ,
   'LBL_MODULE_TITLE' => 'Ценоразпис: Начало' ,
   'LBL_SEARCH_FORM_TITLE' => 'Търси цени' ,
   'LBL_LIST_FORM_TITLE' => 'Цени' ,
   ...
   'LNK_NEW_PRICE' => 'Нова цена' ,
   'LNK_PRICE_LIST' => 'Цени' ,
   'LBL_DEFAULT_SUBPANEL_TITLE' => 'Ценоразпис' ,
   'LBL_ACTIVITIES_TITLE' => 'Дейности' ,
   'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Дейности' ,
   'LBL_HISTORY_SUBPANEL_TITLE' => 'История' ,
   'LBL_QUICK_NEW_PRICE' => 'Нова цена' ,
   'LBL_LIST_SUBPNANEL_DUE_DATE' => 'Валидна до' ,
   'LBL_LIST_SUBPNANEL_SUPPLIER_NAME' => 'Доставчик' ,
   'LBL_LIST_SUBPNANEL_ISVALID' => 'Вадидност' ,
