...
$current_module_strings = return_module_language($current_language, 'Price');
...
$button .= "<input type='hidden' name='module' value='Price'>\n";
...
$ListView->initNewXTemplate( 'modules/Prices/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRICE_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_PRICE_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "PRICE");
