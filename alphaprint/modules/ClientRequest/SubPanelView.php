...
$button .= "<input type='hidden' name='module' value='ClientRequest'>\n";
...
$ListView->initNewXTemplate( 'modules/ClientRequest/SubPanelView.html',$current_module_strings);
...
$ListView->setHeaderTitle($current_module_strings['LBL_CLIENTREQUEST_SUBPANEL_TITLE'] );
...
$ListView->setHeaderTitle($current_module_strings['LBL_CLIENTREQUEST_SUBPANEL_TITLE'] . $header_text);

$ListView->processListView($focus_list, "main", "CLIENTREQUEST");
