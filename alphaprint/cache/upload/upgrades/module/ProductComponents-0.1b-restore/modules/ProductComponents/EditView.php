...
$xtpl->assign('priority_options', get_select_options_with_id($app_list_strings['product_components_priority_options'], $focus->priority));
...
$xtpl->assign('utilization_options',
	get_select_options_with_id($app_list_strings['product_components_utilization_options'],
	$focus->utilization));
$xtpl->assign('task_number', $focus->task_number);
