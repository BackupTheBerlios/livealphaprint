<?php /* Smarty version 2.6.11, created on 2007-07-20 13:20:51
...
'>
			<?php if ($this->_tpl_vars['USE_SEARCH_GIF']): ?>
				&nbsp;<input type="image" value="<?php echo $this->_tpl_vars['LBL_SEARCH_BUTTON_LABEL']; ?>
" src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
searchButton.gif" align="top" width="25" height="17" class="searchButton">
			<?php else: ?>
