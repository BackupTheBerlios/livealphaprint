...
EOQ;
		...
		if (!empty($_REQUEST['mode']) && strtoupper($_REQUEST['mode']) == 'MULTISELECT') {
			...
			if ($currentModule == "Operations"){
				...
				$button .= "<input type='button' name='button' class='button' onclick=\"send_back_selected_operations('$currentModule',document.MassUpdate,'mass[]','" .$app_strings['ERR_NOTHING_SELECTED']."', request_data.field_to_name_array);\" title='"
				.$app_strings['LBL_SELECT_BUTTON_TITLE']."' accesskey='"
				.$app_strings['LBL_SELECT_BUTTON_KEY']."' value='  "
				.$app_strings['LBL_SELECT_BUTTON_LABEL']."  ' />\n";	
			}
			
			elseif ($currentModule == "Rateplate"){
				$button .= "<input type='hidden' name='mode' value='MultiSelect'>";
				$button .= "<input type='button' name='button' class='button' onclick=\"send_back_selected_plates('$currentModule',document.MassUpdate,'mass[]','" .$app_strings['ERR_NOTHING_SELECTED']."', request_data.field_to_name_array);\" title='"
				.$app_strings['LBL_SELECT_BUTTON_TITLE']."' accesskey='"
				.$app_strings['LBL_SELECT_BUTTON_KEY']."' value='  "
				.$app_strings['LBL_SELECT_BUTTON_LABEL']."  ' />\n";	
			}
			
			elseif ($currentModule == "Ratefilm"){
				$button .= "<input type='hidden' name='mode' value='MultiSelect'>";
				$button .= "<input type='button' name='button' class='button' onclick=\"send_back_selected_plates('$currentModule',document.MassUpdate,'mass[]','" .$app_strings['ERR_NOTHING_SELECTED']."', request_data.field_to_name_array);\" title='"
				.$app_strings['LBL_SELECT_BUTTON_TITLE']."' accesskey='"
				.$app_strings['LBL_SELECT_BUTTON_KEY']."' value='  "
			...
			elseif ($currentModule == "Ink"){
				$button .= "<input type='hidden' name='mode' value='MultiSelect'>";
				$button .= "<input type='button' name='button' class='button' onclick=\"send_back_selected_inks('$currentModule',document.MassUpdate,'mass[]','" .$app_strings['ERR_NOTHING_SELECTED']."', request_data.field_to_name_array);\" title='"
				.$app_strings['LBL_SELECT_BUTTON_TITLE']."' accesskey='"
				.$app_strings['LBL_SELECT_BUTTON_KEY']."' value='  "
				.$app_strings['LBL_SELECT_BUTTON_LABEL']."  ' />\n";	
			}
