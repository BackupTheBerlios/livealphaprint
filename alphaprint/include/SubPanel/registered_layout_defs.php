...
//Peter Peshev
require_once('modules/Products/layout_defs.php');
require_once('modules/ProductComponents/layout_defs.php');
require_once('modules/Suppliers/layout_defs.php');
require_once('modules/Paper/layout_defs.php');
require_once('modules/Suppliers/layout_defs.php');
