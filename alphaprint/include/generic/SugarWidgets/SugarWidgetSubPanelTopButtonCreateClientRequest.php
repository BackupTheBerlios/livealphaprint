...
class SugarWidgetSubPanelTopButtonCreateClientRequest extends SugarWidgetSubPanelTopButton
{
	...
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		$button .= '<input type="hidden" name="status_action" value="create_clientrequest">';
		...
		$button .= '<input type="hidden" name="product_id" value="' . $defines['focus']->id . "\" />\n";
