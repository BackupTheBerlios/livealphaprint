...
class SugarWidgetSubPanelTopButtonCreateEstimate extends SugarWidgetSubPanelTopButton
{
	...
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		$button .= '<input type="hidden" name="status_action" value="create_estimate">';
