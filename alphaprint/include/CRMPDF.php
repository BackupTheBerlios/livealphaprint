 ...
 */
function addImage( $logo_name, $location=array('10','10','51','10') ) {
	//XXX ftreml
	global $theme;
    ...
    $stretchx = $location[2];
    $stretchy = $location[3];
    $this->Image($image_path.$logo_name,$x1,$y1,$stretchx,$stretchy);
}
 ...
 *
 */
function addCompanyTitle( $title,$text,$positions )
{
    $r1  = $positions[0];
    $y1  = $positions[1];
    $this->SetXY( $r1, $y1);
    $this->SetFont( "FreeSerif", "", 13);
