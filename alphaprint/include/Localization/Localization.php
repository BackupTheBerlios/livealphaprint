...
class Localization {
	 ...
	 * @return string charset the chosen character set
	 */
	function getOutboundEmailCharset() {
		$charset = $this->getPrecedentPreference('default_email_charset');
		return $charset;
	}
...
eoq;
	 ...
	 */
	function getLocaleFormattedName($firstName, $lastName, $salutationKey='', $format="") {
		global $current_user;
